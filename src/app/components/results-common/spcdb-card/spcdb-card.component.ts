...
// // import { ViewChild, AfterViewInit, ChangeDetectorRef, ElementRef, ViewEncapsulation, HostListener } from '@angular/core';
...
// // })
// // export class SpcdbCardComponent {
...
// //     SpcdbCardComponent.apiCallCount++; // Rename class appropriately
// //     this.localCount = SpcdbCardComponent.apiCallCount;
// //     console.log('localcount=', this.localCount);
...
// //         this.scientific_docs_column[column_list[this.resultTabs.scientificDocs.name][i].value] =
// //           column_list[this.resultTabs.scientificDocs.name][i].name;
// //       }
// //     }
// //     console.log('scientificDocs', this.scientific_docs_column)
// //     this._data = value;
// //     console.log('data',this._data);
// //     // Call search function after setting data
// //     this.scientificDocsSearch({
// //       searchWith: value.search_type || '', 
// //       searchWithValue: value.keyword || '', 
// //       index: value.index || 0
// //     });
...
//   styleUrls: ['./spcdb-card.component.scss']
// })
// export class SpcdbCardComponent implements AfterViewInit {
//   displayedColumns: string[] = ['sno', 'country', 'activeIngredients', 'casRns', 'iupacName', 'indication', 'chemicalClass'];
//   dataSource = new MatTableDataSource<any>([
//     { sno: 1, country: 'USA', activeIngredients: 'Aspirin', casRns: '50-78-2', iupacName: '2-acetoxybenzoic acid', indication: 'Pain relief', chemicalClass: 'Salicylate' },
//     { sno: 2, country: 'India', activeIngredients: 'Paracetamol', casRns: '103-90-2', iupacName: 'N-(4-hydroxyphenyl)acetamide', indication: 'Fever', chemicalClass: 'Aniline' },
...
//       body: this.dataSource.filteredData.map(row => this.displayedColumns.map(col => row[col])),
//     });
...
@Component({
  ...
  imports:[MatTableModule,
    ...
    MatInputModule,
    MatButtonModule,
    CommonModule,  // if you're in a feature module
  ],
  styleUrls: ['./spcdb-card.component.scss']
})
export class SpcdbCardComponent implements AfterViewInit {
...
// }
  ...
  fetchScientificDocs() {
    const apiUrl = 'https://apilive.chemrobotics.com/scientific-docs/search-specific';
  ...
  clearFilter(column: string, input: HTMLInputElement) {
    input.value = '';
    this.applyFilter(new Event('keyup'), column);
  }
}