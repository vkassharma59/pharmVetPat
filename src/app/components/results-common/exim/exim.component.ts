...
export class EximComponent implements AfterViewInit {
  displayedColumns: string[] = [
    'GBRN', 'PRODUCTNAME', 'APIAGROCHEMICALINTERMEDIATE',
  ...
  ngAfterViewInit() {
    ...
    console.log('Scroll container:', this.tableContainer.nativeElement);
  ...
  filterableColumns = ['COUNTRYOFORIGIN', 'GBRN']; // example keys
...
const ELEMENT_DATA = [
  ...
  },
  {
    ...
    PRODUCTNAME: 'FREE SAMPLE:Placebo of Sitagliptin table ts 100 MG; Batch No: ASSITT6017; Mfg. Date: Apr-19; Expiry Date: Mar-21',
    APIAGROCHEMICALINTERMEDIATE: 'FREE SAMPLE:Placebo of Sitagliptin table ts 100 MG; Batch No: ASSITT6017; Mfg. Date: Apr-19; Expiry Date: Mar-21',
    ITEMDESCRIPTION: 'FREE SAMPLE:Placebo of Sitagliptin table ts 100 MG; Batch No: ASSITT6017; Mfg. Date: Apr-19; Expiry Date: Mar-21',
    ...
    SUPPLIERADDRESS: 'FREE SAMPLE:Placebo of Sitagliptin table ts 100 MG; Batch No: ASSITT6017; Mfg. Date: Apr-19; Expiry Date: Mar-21',
    IECIMPORTERCODE: '896004341',
    INVOICENO: 'SAM-0342/19-20'
